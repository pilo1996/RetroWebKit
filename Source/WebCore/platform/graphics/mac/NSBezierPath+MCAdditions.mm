...
extern "C" CGPathRef CGContextCopyPath(CGContextRef context);
#endif
...
{
    auto nsPath = RetainPtr<NSBezierPath>([NSBezierPath bezierPathWithCGPath:path]);
    return NSRectToCGRect([nsPath.get() bounds]);
}
